...
fr_point, fr_ring, diameter, inclination, pos_angle = 0.4, 0.6, 10, 0.351, 33
components = [PointSource(fr=fr_point), Ring(fr=fr_ring, rin=diameter/2, inc=inclination, pa=pos_angle)]
...
ring = {"fr": fr_r, "rin": rin, "inc": inc, "pa": pa}
